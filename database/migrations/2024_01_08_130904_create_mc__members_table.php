...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('mc_members', function (Blueprint $table) {
            ...
            $table->string('v_idnumber', 50)->nullable();
            $table->text('v_address')->nullable();
            $table->string('v_city', 200);
            $table->string('v_zipcode', 20)->nullable();
            $table->date('dt_birthdate')->nullable();
            $table->tinyInteger('b_gender')->default(0)->comment('1=Male, 2=Female');
            $table->string('v_picture', 50)->nullable();
            $table->string('v_accesscard', 200)->nullable();
            ...
            $table->string('v_room', 50)->nullable();
