            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>Event Space - Sewa Event Space Komunitas</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div id="slider-carousel" class="owl-carousel">
                            <div class="item">
                                <img src="{{ asset('frontoffice/assets/images/location-details-slider/trilium/5a.jpg') }}"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontoffice/assets/images/location-details-slider/trilium/4a.jpg') }}"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontoffice/assets/images/location-details-slider/trilium/8a.jpg') }}"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <h3>Overview</h3>
                        <p>Punya rencana untuk mengadakan acara komunitas? Ruangan di MyCo fleksibel untuk dimodifikasi
                            sesuai kebutuhan event Anda, yuk kunjungi MyCo dan MyCo X.</p>
                        <div class="col-md-12 mb-sm-30 mb-4">
                            <div class="box-custom">
                                <ul class="list s1 indented-list-2">
                                    <li>Event space yang luas</li>
