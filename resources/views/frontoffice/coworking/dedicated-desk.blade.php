            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>Dedicated Desk - Coworking Area</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div id="slider-carousel" class="owl-carousel">
                            ...
                            <div class="item">
                                <img src="{{ asset('frontoffice/assets/images/location-details-slider/indragiri/6a.jpg') }}"
                                    alt="">
                            </div>
                            {{-- <div class="item">
                                <img src="{{ asset('frontoffice/assets/images/location-details-slider/cw/5.jpg') }}"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('frontoffice/assets/images/location-details-slider/cw/6.jpg') }}"
                                    alt="">
                            </div> --}}
                        </div>
